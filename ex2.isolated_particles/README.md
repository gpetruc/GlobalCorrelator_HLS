...
Write an algorithm to reconstruct high p<sub>T</sub> isolated charged particles starting from the list of all particles (L1 Puppi objects) in the event.
...
the encoding of the remaining bits different for charged and neutral particles, and are not used in this exercise.
 ...
 * if the new p<sub>T</sub> particle is isolated, add it to the output list and save its isolation value
 * repeat
