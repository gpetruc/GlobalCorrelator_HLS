...
open_project -reset "project_csim_pf_puppi_tmux18"

set_top ${hlsTopFunc}

add_files -tb regionizer_ref.cpp -cflags "${cflags}"
add_files -tb readMC.cpp -cflags "${cflags}"
add_files -tb regionizer_pf_puppi_test_tmux18.cpp -cflags "${cflags}"
add_files -tb ../utils/pattern_serializer.cpp -cflags "${cflags}"
add_files -tb ../utils/pattern_multiplexer.h -cflags "${cflags}"
